...
function compileSCSS() {
  log(chalk.red.bold('---------------Compilando SASS---------------'));
...
function compileHTML() {
  log(chalk.red.bold('---------------Compilando HTML---------------'));
  panini.refresh();
...
// COPY CUSTOM JS
function compileJS() {
  log(chalk.red.bold('---------------Compilando custom.js---------------'));
...
function resetPages(done) {
  log(chalk.red.bold('---------------Simpiando la cahce de Panini---------------'));
  panini.refresh();
  done();
}
...
// SCSS LINT
function scssLint() {
  log(chalk.red.bold('---------------Listando SCSS---------------'));
...
// HTML LINTER
function htmlLint() {
  log(chalk.red.bold('---------------Comprobando HTML---------------'));
...
function htmllintReporter(filepath, issues) {
  if (issues.length > 0) {
    ...
    log(chalk.green.bold('---------------No hay errores de html---------------'));
  }
}
